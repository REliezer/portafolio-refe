...
1. From the project directory, install Node dependencies: `npm install`
2. From the project directory, build: `npm run dev`
3. See your changes live at `http://localhost:4321`
